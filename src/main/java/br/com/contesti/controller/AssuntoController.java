...
public class AssuntoController {
	...
	@ResponseBody
	public ModelAndView createAssunto(@RequestParam Disciplina disciplina, @RequestParam String descricao, RedirectAttributes attributes, @Valid Assunto assunto,
