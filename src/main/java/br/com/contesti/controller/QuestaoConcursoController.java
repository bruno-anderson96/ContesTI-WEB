...
public class QuestaoConcursoController {
	...
	@ResponseBody
	public ModelAndView createConcurso(@RequestParam String pergunta,
			...
			@RequestParam(name = "assuntoDescricao", defaultValue = "") String assuntoDescricao,
		...
		if (assuntoDescricao.isEmpty()) {
			...
			attributes.addFlashAttribute("erro", "Selecione uma banca");
			return mv;
